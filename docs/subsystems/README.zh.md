...
| [business-workflow.md](business-workflow.zh.md) | 业务工作流 seam：clarify/compose/verify 阶段机、`RequirementSubmission`、`WorkflowComposition`、`VerificationReport`、`business-workflow/*` 事件 |
