...
| [business-workflow.md](business-workflow.md) | the business-workflow seam: the clarify/compose/verify stage machine, `RequirementSubmission`, `WorkflowComposition`, `VerificationReport`, the `business-workflow/*` events |
