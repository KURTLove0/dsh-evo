...
export const en = {
  nav: 'Runtimes',
  title: 'Runtimes',
  intro: 'Model runtimes this deployment can call. Live runtimes list the models they currently load.',
  retry: 'Retry',
  loadFailed: 'Loading runtimes failed',
  empty: 'No model runtimes are declared in this deployment.',
  statusActive: 'Active',
  ...
  configHint: 'Configure this runtime on the Models page.',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  nav: '运行时',
  title: '运行时',
  intro: '当前部署可调用的模型运行时。处于活跃状态的运行时会列出其当前加载的模型。',
  retry: '重试',
  loadFailed: '加载运行时失败',
  empty: '当前部署未声明任何模型运行时。',
  statusActive: '活跃',
  statusDormant: '未启用',
  modelsHeading: '已加载模型',
