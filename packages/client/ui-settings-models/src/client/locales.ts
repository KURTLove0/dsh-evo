...
export const en = {
  ...
  cliTimeout: 'Timeout (ms)',
  cliTimeoutInvalid: 'Timeout must be a positive integer of milliseconds, like 300000.',
  runtimeRouteInactive: 'This runtime is not active yet — save its configuration first, then fetch.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  cliCommand: 'CLI 命令',
  cliTimeout: '超时（毫秒）',
  cliTimeoutInvalid: '超时必须是正整数毫秒值，例如 300000。',
  runtimeRouteInactive: '该运行时尚未激活——请先保存其配置，再获取模型。',
