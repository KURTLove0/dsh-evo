...
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'Local runtimes report the models they load; API providers are configured with their keys below.',
  runtimesGroup: 'Runtimes',
  modelApisGroup: 'Model APIs',
  statusActive: 'Active',
  runtimeModelsEmpty: 'No models listed. Unlisted IDs can still be requested directly.',
  runtimeModelsFailure: 'Model listing failed',
  edit: 'Edit',
...
export const zh: { [Key in keyof typeof en]: string } = {
  nav: '模型',
  title: '模型',
  intro: '本地运行时展示其加载的模型；模型 API 提供方在下方以密钥配置。',
  runtimesGroup: '运行时',
  modelApisGroup: '模型 API',
  statusActive: '活跃',
  runtimeModelsEmpty: '未列出任何模型；目录外 ID 仍可直接请求。',
  runtimeModelsFailure: '模型列表获取失败',
  edit: '编辑',
