/** Package-owned invariant companion for the business-workflow UI plugin. */

/* jscpd:ignore-start */
import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-business-workflow'

/** Cordis companion plugin name. */
export const name = 'client-ui-business-workflow-invariant'
