...
| [`business/`](business/README.md) | Business-workflow capability family: seam, process-local runtime, and the model-facing `business_workflow_*` tools | Product — stable API |
