...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  businessWorkflows: 'business-workflow.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AcceptanceCase: 'business-workflow.md',
  AcceptanceExpectation: 'business-workflow.md',
  BusinessWorkflowId: 'business-workflow.md',
  BusinessWorkflowInfo: 'business-workflow.md',
  BusinessWorkflowSnapshot: 'business-workflow.md',
  BusinessWorkflowStage: 'business-workflow.md',
  CaseResult: 'business-workflow.md',
  ClarificationGap: 'business-workflow.md',
  CompositionIssue: 'business-workflow.md',
  CompositionOutcome: 'business-workflow.md',
  CompositionRequest: 'business-workflow.md',
  RequirementAnalysis: 'business-workflow.md',
  RequirementSpec: 'business-workflow.md',
  RequirementSubmission: 'business-workflow.md',
  RequirementSubmissionRequest: 'business-workflow.md',
  StaticCheck: 'business-workflow.md',
  StepExecutionTrace: 'business-workflow.md',
  VerificationReport: 'business-workflow.md',
  VerificationRequest: 'business-workflow.md',
  VerificationSummary: 'business-workflow.md',
  WorkflowComposition: 'business-workflow.md',
  WorkflowStep: 'business-workflow.md',
